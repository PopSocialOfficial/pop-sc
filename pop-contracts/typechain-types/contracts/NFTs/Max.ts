...
export interface MaxInterface extends utils.Interface {
  functions: {
    ...
    "listOfMaxTokenIds(uint256)": FunctionFragment;
    "listOfTokenIdsOwned(address)": FunctionFragment;
    "maxContract()": FunctionFragment;
    ...
    "updateComponents(uint256,uint256[],string)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "listOfMaxTokenIds",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateComponents",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<string>
...
export interface Max extends BaseContract {
  ...
  functions: {
    ...
    maxContract(overrides?: CallOverrides): Promise<[string]>;
    ...
    safeMint(
      _maxComponents: PromiseOrValue<BigNumberish>[],
  ...
  estimateGas: {
    ...
    maxContract(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    maxContract(overrides?: CallOverrides): Promise<PopulatedTransaction>;
