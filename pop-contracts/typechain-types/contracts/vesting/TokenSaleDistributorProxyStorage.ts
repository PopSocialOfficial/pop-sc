...
export interface TokenSaleDistributorProxyStorageInterface
...
export interface TokenSaleDistributorProxyStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenSaleDistributorProxyStorageInterface;
