...
async function main() {
  ...
  const genesisNFT = GenesisNFTV1.attach('0xC1Dd2B220559d44Dab31f753bEcD4B030fAa5ef8')
  ...
  const genesisNFT2 = await upgrades.upgradeProxy('0xC1Dd2B220559d44Dab31f753bEcD4B030fAa5ef8', GenesisNFTV2);
  console.log('\n\n')
  console.log('name', await genesisNFT.name())
  console.log('symbol', await genesisNFT.symbol())
  console.log('totalSupply', await genesisNFT.totalSupply())
