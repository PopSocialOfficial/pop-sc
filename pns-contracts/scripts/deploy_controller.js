...
async function main() {
    ...
    const RegistrarControllerV1_SourceName = 'contracts/registrar/RegistrarController.sol'
    ...
    let RegistrarControllerResultFactory = await ethers.getContractFactory(RegistrarControllerV1_SourceName + ":RegistrarController");
    ...
    await hre.run("verify:verify", {
        ...
        contract: RegistrarControllerV1_SourceName + ":RegistrarController",
