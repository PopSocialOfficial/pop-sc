...
function shouldRespectConstraints(contracts, getSigners) {
  ...
  let parentNode = namehash('test1.pop')
  let childNode = namehash('sub.test1.pop')
  let childLabel = 'sub'
  ...
  function testStateTransition1000to1010({
    ...
    it('1000 => 1010 - Parent cannot burn PCC with setChildFuses()', async () => {
      ...
      await expect(
        ...
        `OperationProhibited("0x1c3ff1e3f527f3ff163f37bc993a015215638e531eba55967157390027d96a34")`,
      )
    })
